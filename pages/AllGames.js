  ...
  return (
    <>
      ...
      <section className='flex flex-col '>
        ...
        <input type="search" placeholder='Search For Games' value={searchtext} onChange={HandleChange}  className=' bg-gray-500 mx-[10vw] rounded-md py-2 my-4 placeholder:text-white text-center ' />
