  ...
  return (
    <>
          ...
          <div className="text-xs bg-black w-full text-white  px-6 py-4 font-bold font-sans  lg:-mt-44 lg:bg-transparent lg:pl-28">
            <strong className="text-slate-400 ">Home</strong> &rarr; <span>{FPS[0].category}</span>  
          </div>
              </div>
        )}
          ...
          <div className="rounded cards bg-white flex flex-col items-center justify-center mx-4 pb-12  my-3 ">
